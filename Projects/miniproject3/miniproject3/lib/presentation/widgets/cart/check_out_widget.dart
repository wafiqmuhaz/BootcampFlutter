...
import 'package:pengayaanfirebase/core/constants/routes_name.dart';
import 'package:pengayaanfirebase/core/constants/strings.dart';
import 'package:pengayaanfirebase/core/utils/enum.dart';
import 'package:pengayaanfirebase/core/widgets/elevated_loading_button_widget.dart';
import 'package:pengayaanfirebase/presentation/blocs/cart/cart_bloc.dart';
import 'package:pengayaanfirebase/presentation/blocs/purchase/purchase_bloc.dart';
import 'package:pengayaanfirebase/presentation/blocs/stripe/stripe_bloc.dart';
        ...
        children: [
          ...
          Row(
            ...
            children: [
              ...
              Text(
                'Rp. ${cartState.subTotal.toStringAsFixed(2)}',
          ...
          Row(
            ...
            children: [
              ...
              Text(
                'Rp. ${cartState.transactionFee.toStringAsFixed(2)}',
                style: const TextStyle(
                  color: AppColors.textPrimary,
                  fontSize: 16,
                  fontWeight: FontWeight.w600,
          ...
          Row(
            ...
            children: [
              ...
              Text(
                'Rp. ${cartState.totalPrice.toStringAsFixed(2)}',
                style: const TextStyle(
                  color: AppColors.textPrimary,
                  fontSize: 16,
                  fontWeight: FontWeight.w600,
