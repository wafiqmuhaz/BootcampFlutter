...
import 'package:finalappsanber/common/point_extension.dart';
...
class _ContentMemberCheckoutState extends State<_ContentMemberCheckout> {
  ...
  final List<String> _bankMethods = ['BCA', 'MANDIRI', 'BRI', 'BNI'];

  late String _selectedPaymentMethod;
  late String _selectedBankPaymentMethod;
  int _usedPoints = 0;
  int _endTotal = 0;
  ...
  void initState() {
    ...
    _selectedBankPaymentMethod = _bankMethods[0];
        ...
        child: Column(
          children: [
            ...
            ListTile(
              ...
              trailing: DropdownButtonHideUnderline(
                child: DropdownButton(
                  value: _selectedBankPaymentMethod,
                  borderRadius: BorderRadius.circular(16),
                  style: Theme.of(context).textTheme.bodyMedium,
                  items: _bankMethods
                      .map((item) => DropdownMenuItem(
                  ...
                  onChanged: (value) {
                    setState(() {
                      _selectedBankPaymentMethod = value!;
                    });
                  },
                ),
              ),
        ...
        child: ElevatedButton.icon(
          onPressed: () async {
            ...
            await NotificationHelper.flutterLocalNotificationsPlugin.show(
              ...
              "Pembayaran item telah berhasil!",
            ...
            final dataTransaction = TransactionEntity(
              ...
              paymentBankMethod: _selectedBankPaymentMethod,
