...
class AuthRepositoryImpl implements AuthRepository {
  ...
  Future<Either<Failure, User>> registerWithEmail(
      String name, String telp, String email, String password) async {
    try {
      final result = await remoteDataSource.registerWithEmail(name, telp, email, password);
      return Right(result.toEntity());
    } catch (e) {
      return Left(RegistrationFailure('Registration failed: ${e.toString()}'));
    }
  }
  ...
  Future<Either<Failure, User>> loginWithEmail(
    ...
    try {
      final result = await remoteDataSource.loginWithEmail(email, password);
      return Right(result.toEntity());
    } catch (e) {
