...
import 'package:finalappsanber/data/models/cart_model.dart';
...
class TransactionModel extends Equatable {
  ...
  factory TransactionModel.fromSnapshot(DocumentSnapshot doc) =>
      TransactionModel(
        ...
        paymentBankMethod: doc.get('method_bank_payment'),
      );
  ...
  factory TransactionModel.fromEntity(TransactionEntity transaction) =>
      TransactionModel(
        ...
        paymentBankMethod: transaction.paymentBankMethod,
      );
  ...
  Map<String, dynamic> toDocument() => {
        ...
        'method_bank_payment': paymentBankMethod,
  ...
  TransactionEntity toEntity() => TransactionEntity(
        ...
        createdAt: createdAt,
        paymentBankMethod: paymentBankMethod,
      );
